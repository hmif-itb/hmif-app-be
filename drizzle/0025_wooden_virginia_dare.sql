CREATE TABLE IF NOT EXISTS "form_responses" (
	...
	CONSTRAINT "form_responses_form_id_user_id_unique" UNIQUE("form_id","user_id")
);
...
CREATE TABLE IF NOT EXISTS "forms" (
	...
	"title" text NOT NULL,
	"description" text,
	"eligible_angkatan" json DEFAULT '[]'::json NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "form_responses" ADD CONSTRAINT "form_responses_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
